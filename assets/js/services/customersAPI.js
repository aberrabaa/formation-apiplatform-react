  ...
  return axios
    ...
    .then(async (response) => {
      ...
      if (cachedCustomers) {
        ...
        // Pas forcément utile car on a modifié le tableau directement en cache à la ligne du dessus
        // mais je garde par principe
        Cache.set("customers", cachedCustomers);
      }
      return response;
    });

  // On pourrait aussi supprimer la clé de cache completement
  // .then(response => {
